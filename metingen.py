...
locatie = "Apeldoorn"
API_temp = f"https://weather.visualcrossing.com/\
    VisualCrossingWebServices/rest/services/timeline/{locatie}\
...
def post_external_data():
    ...
    if response.status_code == 200:
        ...
        insertMetingen = f"INSERT INTO metingen (locatieId, datetime) \
            VALUES ((SELECT locatieId FROM locaties WHERE locatie = \
