...
def create_meting(nieuwe_meting: WeerMeting, key: str = Depends(verify_api_key)):
...
def create_meting_uren_batch(nieuwe_metingen: List[WeerMetingUren], key: str = Depends(verify_api_key)):
...
def create_voorspelling(nieuwe_voorspelling: Voorspelling, key: str = Depends(verify_api_key)):
...
def create_voorspelling_uren_batch(nieuwe_voorspellingen: List[VoorspellingUren], key: str = Depends(verify_api_key)):
